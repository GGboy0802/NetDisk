...
QT_MOC_LITERAL(8, 80, 23), // "SIG_PlaybackRateChanged"
QT_MOC_LITERAL(9, 104, 4), // "rate"
QT_MOC_LITERAL(10, 109, 15), // "SendGetOneImage"
QT_MOC_LITERAL(11, 125, 7) // "QImage&"

    },
    "VideoPlayer\0SIG_getOneImage\0\0img\0"
    "SIG_PlayerStateChanged\0flag\0SIG_TotalTime\0"
    "uSec\0SIG_PlaybackRateChanged\0rate\0"
    "SendGetOneImage\0QImage&"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->SIG_PlaybackRateChanged((*reinterpret_cast< double(*)>(_a[1]))); break;
        ...
        {
            using _t = void (VideoPlayer::*)(double );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoPlayer::SIG_PlaybackRateChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void VideoPlayer::SIG_PlaybackRateChanged(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
